...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("grandmother", "ama", R.drawable.family_grandmother, R.color.category_family));
        words.add(new Word("grandfather", "paapa", R.drawable.family_grandfather, R.color.category_family));
